      ...
      <div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-1">
        ...
        <div class="d-flex flex-center flex-column flex-lg-row-fluid">
          ...
          <div class="w-lg-500px p-10">
            <!--begin::Form-->
            <form class="form w-100" novalidate="novalidate" id="kt_sign_up_form" @submit.prevent="onSubmit">
              <!--begin::Heading-->
              ...
              <div class="fv-row mb-8">
                <!--begin::Email-->
                <input type="text" placeholder="Username" name="username" autocomplete="off" class="form-control bg-transparent" v-model="username" />
                <!--end::Email-->
              </div>
              <div class="fv-row mb-8">
                <!--begin::Email-->
              ...
              <div class="fv-row mb-8">
                ...
                <input placeholder="Repeat Password" name="confirm-password" type="password" autocomplete="off" class="form-control bg-transparent" v-model="password_confirmation" />
                <!--end::Repeat Password-->
              </div>
              <!--end::Input group=-->
              <!--begin::Submit button-->
              ...
              <div class="text-gray-500 text-center fw-semibold fs-6">Already have an Account?
                <router-link to="/sign-in" class="link-primary fw-semibold">Sign in</router-link>
              </div>
              <!--end::Sign up-->
            </form>
            <!--end::Form-->
